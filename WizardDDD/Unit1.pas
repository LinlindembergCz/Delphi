...
begin
  ...
  MemoRepository.lines.Add('');
  MemoRepository.lines.Add('initialization RegisterClass('+'TService' +Entity+');');
  MemoRepository.lines.Add('finalization UnRegisterClass('+'TService' +Entity+');');
  MemoRepository.lines.Add('');
  MemoService.lines.Add('end.');
...
begin
  ...
  MemoRepository.lines.Add('');
  MemoRepository.lines.Add('initialization RegisterClass('+'TController' +Entity+');');
  MemoRepository.lines.Add('finalization UnRegisterClass('+'TController' +Entity+');');
  MemoRepository.lines.Add('');
  MemoController.lines.Add('end.');
